...
import com.ECFW.ActiTimeGENERIC.PropertyFileHandle;
...
@Listeners(com.ECFW.ActiTimeGENERIC.Listener.class)
public class BaseTest implements AutoConstants
{
	...
	public void preCondition(@Optional("abc") String browsername)
	{
		...
		String str = PropertyFileHandle.getPropertyValue("ActitimeURL");
		driver.get(str);
	}
